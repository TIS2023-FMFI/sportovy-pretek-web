  ...
  <div id="f">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input type="text" name="pohlavie" id="pohlavie" size="30" value="<?php if(isset($_POST['pohlavie'])){echo $_POST['pohlavie'];}else{echo $po->pohlavie;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      if(je_kmenovy($_GET['id'])){ ?>
      <tr>
        <td><label for="datum">Dátum narodenia:</label> </td>
        <td><input type="text" name="narodenie" id="narodenie" size="30" value="<?php if(isset($_POST['narodenie'])){echo $_POST['narodenie'];}else{echo $po->narodenie;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="krajina_narodenia" id="krajina_narodenia" size="30" value="<?php if(isset($_POST['krajina_narodenia'])){echo $_POST['krajina_narodenia'];}else{echo $po->krajina_narodenia;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="statna_prislusnost" id="statna_prislusnost" size="30" value="<?php if(isset($_POST['statna_prislusnost'])){echo $_POST['statna_prislusnost'];}else{echo $po->statna_prislusnost;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="krajina_trvaleho_pobytu" id="krajina_trvaleho_pobytu" size="30" value="<?php if(isset($_POST['krajina_trvaleho_pobytu'])){echo $_POST['krajina_trvaleho_pobytu'];}else{echo $po->krajina_trvaleho_pobytu;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="ulica" id="ulica" size="30" value="<?php if(isset($_POST['ulica'])){echo $_POST['ulica'];}else{echo $po->ulica;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="cislo_domu" id="cislo_domu" size="30" value="<?php if(isset($_POST['cislo_domu'])){echo $_POST['cislo_domu'];}else{echo $po->cislo_domu;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="psc" id="psc" size="30" value="<?php if(isset($_POST['psc'])){echo $_POST['psc'];}else{echo $po->psc;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="mesto" id="mesto" size="30" value="<?php if(isset($_POST['mesto'])){echo $_POST['mesto'];}else{echo $po->mesto;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      //----------------admi-------------
       if(je_kmenovy($_GET['id'])){ ?>
      <tr>
        <td><label for="telefón">Telefón:</label> </td>
        <td><input type="text" name="telefon" id="telefon" size="30" value="<?php if(isset($_POST['telefon'])){echo $_POST['telefon'];}else{echo $po->telefon;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
      ...
      <tr>
        ...
        <td><input type="text" name="mail" id="mail" size="30" value="<?php if(isset($_POST['mail'])){echo $_POST['mail'];}else{echo $po->mail;} ?>"> </td>
      </tr>
      <?php } 
      //-----------------------------------
      ?>
