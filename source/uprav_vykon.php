            ...
            <div class="spravaVykonu">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="MIESTO" id="MIESTO"
                                                       value="<?php if (isset($_POST["MIESTO"])) {
                                                           echo $_POST["MIESTO"];
                                                       } else {
                                                           echo $vykon["MIESTO"];
                                                       } ?>"></td>
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="VITAZ" id="VITAZ"
                                                       value="<?php if (isset($_POST["VITAZ"])) {
                                                           echo $_POST["VITAZ"];
                                                       } else {
                                                           echo $vykon["VITAZ"];
                                                       } ?>"></td>
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="VITAZ_CAS" id="VITAZ_CAS"
                                                       value="<?php if (isset($_POST["VITAZ_CAS"])) {
                                                           echo $_POST["VITAZ_CAS"];
                                                       } else {
                                                           echo $vykon["VITAZ_CAS"];
                                                       } ?>"></td>
                    </tr>
                    <tr>
                        <td class="table-left"
                        <label>Môj čas:</label></td>
                        <td class="table-right"><input type="text" name="MOJ_CAS" id="MOJ_CAS"
                                                       value="<?php if (isset($_POST["MOJ_CAS"])) {
                                                           echo $_POST["MOJ_CAS"];
                                                       } else {
                                                           echo $vykon["MOJ_CAS"];
                                                       } ?>"></td>
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="VZDIALENOST" id="VZDIALENOST"
                                                       value="<?php if (isset($_POST["VZDIALENOST"])) {
                                                           echo $_POST["VZDIALENOST"];
                                                       } else {
                                                           echo $vykon["VZDIALENOST"];
                                                       } ?>"></td>
                    </tr>
                    <tr>
                        <td class="table-left"><label>Ideálna vzdialenosť v km:</label></td>
                        <td class="table-right"><input type="text" name="IDEAL_VZDIALENOST" id="IDEAL_VZDIALENOST"
                                                       value="<?php if (isset($_POST["IDEAL_VZDIALENOST"])) {
                                                           echo $_POST["IDEAL_VZDIALENOST"];
                                                       } else {
                                                           echo $vykon["IDEAL_VZDIALENOST"];
                                                       } ?>"></td>
                    </tr>
                    <tr>
                        <td class="table-left"><label>Rýchlosť min/km:</label></td>
                        <td class="table-right"><input type="text" name="RYCHLOST" id="RYCHLOST"
                                                       value="<?php if (isset($_POST["RYCHLOST"])) {
                                                           echo $_POST["RYCHLOST"];
                                                       } else {
                                                           echo $vykon["RYCHLOST"];
                                                       } ?>"></td>
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="PREVYSENIE" id="PREVYSENIE"
                                                       value="<?php if (isset($_POST["PREVYSENIE"])) {
                                                           echo $_POST["PREVYSENIE"];
                                                       } else {
                                                           echo $vykon["PREVYSENIE"];
                                                       } ?>"></td>
                    </tr>
                    <tr>
                        <td class="table-left"><label>Odchýlka nabehané/ideálne mínus 1(%):</label></td>
                        <td class="table-right"><input type="text" name="ODCHYLKA" id="ODCHYLKA"
                                                       value="<?php if (isset($_POST["ODCHYLKA"])) {
                                                           echo $_POST["ODCHYLKA"];
                                                       } else {
                                                           echo $vykon["ODCHYLKA"];
                                                       } ?>"></td>
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="PRIRAZKA" id="PRIRAZKA"
                                                       value="<?php if (isset($_POST["PRIRAZKA"])) {
                                                           echo $_POST["PRIRAZKA"];
                                                       } else {
                                                           echo $vykon["PRIRAZKA"];
                                                       } ?>"></td>
                    ...
                    <tr>
                        ...
                        <td class="table-right"><input type="text" name="HODNOTENIE" id="HODNOTENIE"
                                                       value="<?php if (isset($_POST["HODNOTENIE"])) {
                                                           echo $_POST["HODNOTENIE"];
                                                       } else {
                                                           echo $vykon["HODNOTENIE"];
                                                       } ?>"></td>
                    </tr>
                    <tr>
