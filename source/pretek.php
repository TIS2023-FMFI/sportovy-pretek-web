        ...
        foreach ($_POST['incharge'] as $val) {
            if ($val != "-") {
                ...
                if (in_array($id_pouz, $_POST['checked'])) {
                    ...
                    $prihlaseni[] = $p->meno . " " . $p->priezvisko;
    ...
    <form method="post">
                ...
                <table class="n">
                    ...
                    <tr>
                        <td>
                            ...
                            Ak sa ani tak nenájdete (ste tu prvý raz), vyplňte položky v prázdnom riadku, zakliknite
                            štvorček a stlačte PRIHLÁSIŤ NA PRETEKY. <br>
                            Ak potrebujete poradiť, alebo sa chcete prihlásiť mailom, napíšte na adresu
                            balogh@elf.stuba.sk
                        </td>
                    </tr>
                </table>
        ...
        if (over($pr->POZNAMKA)) { ?>
            ...
            <div id="upozornenie">
                <table class="u">
                    <tr>
                        <td style="font-weight:bold;">Pokyny</td>
                    </tr>
                    <tr>
                        <td><?php echo $pr->POZNAMKA; ?></td>
                    </tr>
                </table>
            </div>
            <?php
        ...
        <div id="prihlaseny">
            ...
            <p>
                ...
                if ((isset($_SESSION['admin']) && $_SESSION['admin'] == 1 || ($now < $deadline && $pr->AKTIV == 1))) { ?>
                    <input name="odhlas" type="submit" id="odhlas" value="Odhlásiť z pretekov"
        ...
        <div id="odhlaseny">
            ...
            <p><input name="prihlas" type="submit" id="prihlas" value="Prihlásiť na preteky" style="margin-bottom: 1em">
                ...
                if (!isset($_GET['cookies'])) {
                    ...
                    <input onclick="window.location.href =<?php echo $link; ?>" type='button'
                           value='Menej používateľov'>
                    <?php
                }
                }
                ...
                <input name="del" type="submit" id="del"
                       onclick="return confirm('Naozaj chcete vymazať používateľov?');" value="Vymazať používateľa">
            </p> <!-- aj v admine kde su vsetci pouzivatelia-->
        <?php
        }
