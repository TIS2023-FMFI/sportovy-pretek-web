        ...
        <form method="post" enctype="multipart/form-data">
            <table id="tabulka_uprav_pretek">
                ...
                <tr>
                    ...
                    <td><input type="text" name="nazov" id="nazov" size="30" value="<?php if (isset($_POST['nazov'])) {
                            echo $_POST['nazov'];
                        } else {
                            echo $po->NAZOV;
                        } ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="datum" id="datetimepicker" size="30"
                               value="<?php if (isset($_POST['datum'])) {
                                   echo $_POST['datum'];
                               } else {
                                   echo $po->DATUM;
                               } ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="deadline" id="datetimepicker1" size="30"
                               value="<?php if (isset($_POST['deadline'])) {
                                   echo $_POST['deadline'];
                               } else {
                                   echo $po->DEADLINE;
                               } ?>"></td>
                ...
                <tr>
                    ...
                    <td><textarea cols="80" rows="15" name="poznamka"
                                  id="poznamka"><?php if (isset($_POST['poznamka'])) {
                                echo $_POST['poznamka'];
                            } else {
                                echo $po->POZNAMKA;
                            } ?></textarea></td>
            ...
            <p id="buttons">
                ...
                <input type="submit" name="zmaz" value="Vymaž"
                       onclick="return confirm('Naozaj chcete vymazať preteky?');"">
                <br>
                <?php
