...
EOF;
    ...
    /**
     *nastavi parametre preteku podla zvoleneho id
     */
...
EOF;
        ...
        if ($count > 0) {
            ...
            echo 'Zvoleny pretek neexistuje';
        }
        return null;
    }
...
EOF;
        ...
        $hlavicka_tab_kat = '<table style="width:100%">
          <tr>
            <th class="prvy"></th>
...
EOF;
    ...
    static function vypis_zhodnotenie($ID_PRET)
    {
      ...
      ORDER BY Prihlaseni.id_kat, Zhodnotenie.cas;
EOF;
